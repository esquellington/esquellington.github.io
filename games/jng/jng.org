...
* TODO Balance
** TODO FlameBoss is too hard, actually impossible due to ramming if the player does not have the broom
** TODO Balance flying skulls
* TODO Polish
** TODO Use free sprites to add detail/variety
** TODO Golden key could lead to secret room behind bishop door, procedurally generated, to include all enemies in different "stands" like a gallery
* TODO BUGS
** TODO Collision bugs:
...
** TODO bosses remain dead after continue, so if final boss is dead the game cannot be replayed without resetting the cartridge
