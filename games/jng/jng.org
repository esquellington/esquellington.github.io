...
A classic-inspired jump'n gun with "nonlinear" level layout, a good number of enemy types with unique behaviours, a few bosses, a couple of (not-so) secrets and a cheesy story.

The game is rather short, and meant to be played in Normal or Hard difficulties, but I've included an Easy mode with unlimited hitpoints to allow anybody to finish it by brute force (you'll even get the good ending when finishing the game this way, but you'll feel cheap inside :)
