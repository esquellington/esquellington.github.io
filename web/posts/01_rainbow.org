...
- There was a large water body behind the camera, the Firth of Forth,
  and extends from 10km and 16.5km towards the Sun.

*** Reconstructing the full bows from partial picture

I manually reconstructed the full bows from the partial picture, by
mirroring it horizontally and matching a circle to each bow in
