...
** GOOD org-sketch-insert-screenshot
- Reuse org-sketch to call platform-specific screenshot tool and
  output to org-sketck regular file
- WORKS!
#+BEGIN_SRC emacs-lisp
(org-sketch-insert-screenshot-and-display "PROVA")
#+END_SRC
*** TODO Support other screenshot tools, same as sketch tools
*** TODO Support Windows snipingtool
*** TODO Support Screenshot + Edit
- Use screenshot as input to edit image using a PNG-compatible tool?
*** REFERENCES
- See https://github.com/dfeich/org-screenshot, but quite simple
- There's other options, all pretty simple
** TODO Publish?
- Github
- MELPA?
