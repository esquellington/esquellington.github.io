...
** TODO install in /lisp
- require in init.el
- setup keybindings in init.el
- maybe only in cc mode now?
** TODO Header comment block
* TODO Save laic owned overlay list
** TODO toggle all on/off, if possible
** TODO laic-remove-overlays ONLY owned overlays
** TODO laic-remove-overlay-inside/forward
- remove 1 overlay
* TODO Find latex blocks
- HARDCODED is fine
** DONE \[ \]
