...
**** TODO [#B] Option to preserve SRC/ASM point after recompilation  :MID:
- (simpler) alternative to [[Option to Narrow to function/region]],
  instead of narrowing we'd just keep point in the interest region
...
***** TODO WORKS! Make this optional                                :WIP:
- Customize var maybe?
**** TODO [#B] Option to Narrow to function/region                  :HARD:
