...
**** TODO [#A] Less intrusive compilation args
...
***** TODO [#B] Additional beardbolt-gcc-args
- Could use these to customize -march, etc..., all except optimization level,
  that goes into next one
- "-std=c++17 -fno-exceptions -march=native"
***** TODO Allow binding to Flycheck/Flymake customization to beardbolt customization
